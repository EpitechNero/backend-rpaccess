...
const selectReferentielMaquettes = async () => {
  try {
    const res = await pool.query('SELECT * FROM referentiel_maquettes ORDER BY getreferentielmaquettes, territoire_referentiel_maquettes');
